...
#[structopt(name = "factorization_machine_rustlearn", about = "factorization machine using rustlearn")]
struct Options {
...
fn main() -> io::Result<()> {
    ...
    let mut model = factorization_machines::Hyperparameters::new(28 * 28, 15).one_vs_rest();
    ...
    debug!("accuracy: {}", metrics::accuracy_score(&validation_labels, &prediction_output));
